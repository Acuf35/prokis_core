...
class FanHaritasiCopy extends StatefulWidget {
  List<Map> gelenDBveri;
  bool gelenDurum;
  FanHaritasiCopy(List<Map> dbVeriler,bool durum) {
    gelenDBveri = dbVeriler;
    gelenDurum=durum;
  }
  @override
  State<StatefulWidget> createState() {
    return FanHaritasiCopyState(gelenDBveri,gelenDurum);
  }
}

class FanHaritasiCopyState extends State<FanHaritasiCopy> {
...
//++++++++++++++++++++++++++CONSTRUCTER METHOD+++++++++++++++++++++++++++++++
  FanHaritasiCopyState(List<Map> dbVeri,bool drm) {
                              ...
                              child: Row(
                                children: <Widget>[
                                  Expanded(
                                    flex: 1,
                                    child: SizedBox(
                                      child: Container(padding: EdgeInsets.all(10*oran),
