...
//--------------------------CONSTRUCTER METHOD--------------------------------
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: Metotlar().appBar(dilSecimi, context, oran, 'tv414'),
        body: Column(
          children: <Widget>[
            //Saat ve Tarih
            Row(
                                          ...
                                          onPressed: () {
                                            DatePicker.showDatePicker(context,
                                              ...
                                              if (date.compareTo(DateTime.now())<=0){
                                                ...
                                                _veriGonder('16*$_index*$gun*$ayy*$yil');
                                              }else{
  ...
  Future _degergiris1X2(
    ...
    await showDialog(
      ...
      if (veriGonderilsinMi) {
        ...
        _veriGonder("16*$_index*$kumesTuru*$veri");
      }
    });
  }
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Expanded(
                      ...
                      child: RaisedButton(
                        onPressed: () {
                          _veriGonder("16*21*$kumesTuru*0.95*1.10*1.20");
                        },
                        child: Text(
