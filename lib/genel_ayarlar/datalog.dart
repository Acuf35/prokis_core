...
class DatalogState extends State<Datalog> {
  String dilSecimi = "EN";
  String sifre = "0";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: Metotlar().appBarSade(dilSecimi, context, oran, 'tv729',Colors.blue, baglantiDurum, alarmDurum),
