...
class AylikYemTukGrafigi extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return AylikYemTukGrafigiState();
  }
}

class AylikYemTukGrafigiState extends State<AylikYemTukGrafigi> {
  String dilSecimi = "EN";
  ...
  List<String> gelenDegerYemTukTop = [];
  List<String> gelenDegerYemTukHayBas = [];

  bool yemTukTopVisibility = true;
  bool yemTukHayBasVisibility = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: Metotlar().appBarSade(dilSecimi, context, oran, 'tv818a',
                          ...
                          child: Container(
                            ...
                            child: RawMaterialButton(
                              ...
                              onPressed: () {
                                ...
                                String komut = '7*$tabloAdi*3*4*$ayy';
                                Metotlar()
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    ...
                                    child: IconButton(
                                      ...
                                      onPressed: () {
                                        yazmaSonrasiGecikmeSayaci = 0;
                                        if (!yemTukTopVisibility) {
                                          yemTukTopVisibility = true;
                                          yemTukHayBasVisibility = false;
                                        } else {
                                          yemTukTopVisibility = false;
                                        }
                                        setState(() {});
                                      },
                                      icon: Icon(yemTukTopVisibility == true
                                          ? Icons.check_box
                                          : Icons.check_box_outline_blank),
                                      color: yemTukTopVisibility == true
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    ...
                                    child: IconButton(
                                      ...
                                      onPressed: () {
                                        yazmaSonrasiGecikmeSayaci = 0;
                                        if (!yemTukHayBasVisibility) {
                                          yemTukHayBasVisibility = true;
                                          yemTukTopVisibility = false;
                                        } else {
                                          yemTukHayBasVisibility = false;
                                        }
                                      ...
                                      icon: Icon(yemTukHayBasVisibility == true
                                          ? Icons.check_box
                                          : Icons.check_box_outline_blank),
                                      color: yemTukHayBasVisibility == true
                                          ? Colors.green.shade500
                                          : Colors.blue.shade600,
                                      iconSize: 20 * oran,
                                    ),
                                ...
                                Expanded(
                                  child: Row(
                                    children: <Widget>[
                                      ...
                                      Visibility(
                                          visible: yemTukHayBasVisibility,
                                          child: Spacer()),
                                      //Yem tüketimi Hayvan başına
                                      Visibility(
                                        visible: yemTukHayBasVisibility,
                                                        ...
                                                        child: SizedBox(
                                                          ...
                                                          child: Container(
                                                            child: AutoSizeText(
                                                              ...
                                                              style: TextStyle(
                                                                fontSize: 40,
                                                                color: double.parse(gelenDegerYemTukTop[
                                                                            index]) ==
                                                                        maxValue1
                                                                    ? Colors.red
                                                                    : (double.parse(gelenDegerYemTukTop[index]) ==
                                                                            minValue1
                                                                        ? Colors
                                                                            .blue
                                                                        : Colors
                                                        ...
                                                        child: SizedBox(
                                                          ...
                                                          child: Container(
                                                            child: AutoSizeText(
                                                              ...
                                                              style: TextStyle(
                                                                fontSize: 40,
                                                                color: double.parse(gelenDegerYemTukHayBas[
                                                                            index]) ==
                                                                        maxValue2
                                                                    ? Colors.red
                                                                    : (double.parse(gelenDegerYemTukHayBas[index]) ==
                                                                            minValue2
                                                                        ? Colors
                                                                            .blue
                                                                        : Colors
  ...
  takipEtVeriIsleme(String gelenMesaj) {
    ...
    if (gelenMesaj.contains("yok1")) {
      ...
      for (var i = 1; i < degerler1.length; i++) {
        ...
        gelenDegerYemTukTop.add(degerler1[i].split("*")[2]);
      ...
      for (var i = 1; i < degerler2.length; i++) {
        gelenDegerYemTukHayBas.add(degerler2[i].split("*")[2]);
  ...
  Widget _chart3(double oran) {
    return charts.TimeSeriesChart(
      ...
      primaryMeasureAxis: charts.NumericAxisSpec(
        showAxisLine: true,
        viewport: charts.NumericExtents(-2000, 20000),
        tickProviderSpec: charts.StaticNumericTickProviderSpec(
          <charts.TickSpec<num>>[
            ...
            charts.TickSpec<num>(11000),
            charts.TickSpec<num>(12000),
            charts.TickSpec<num>(13000),
            charts.TickSpec<num>(14000),
            charts.TickSpec<num>(15000),
            charts.TickSpec<num>(16000),
            charts.TickSpec<num>(17000),
            charts.TickSpec<num>(18000),
            charts.TickSpec<num>(19000),
      ...
      secondaryMeasureAxis: charts.NumericAxisSpec(
        showAxisLine: true,
        viewport: charts.NumericExtents(-40, 400),
        tickProviderSpec: charts.StaticNumericTickProviderSpec(
          <charts.TickSpec<num>>[
            charts.TickSpec<num>(0),
            ...
            charts.TickSpec<num>(220),
            charts.TickSpec<num>(240),
            charts.TickSpec<num>(260),
            charts.TickSpec<num>(280),
            charts.TickSpec<num>(300),
            charts.TickSpec<num>(320),
            charts.TickSpec<num>(340),
            charts.TickSpec<num>(360),
            charts.TickSpec<num>(380),
  ...
  List<charts.Series<TimeSeriesSales, DateTime>> _createSampleData3() {
    ...
    for (int i = 0; i <= gelenTarih.length - 1; i++) {
      desktopSalesData.add(new TimeSeriesSales(
          ...
          veriGetir(gelenDegerYemTukTop, i)));
      losAngelesSalesData.add(new TimeSeriesSales(
          DateTime(tarih.year, ayGetir(gelenTarih, i), gunGetir(gelenTarih, i)),
          veriGetir(gelenDegerYemTukHayBas, i)));
    }
