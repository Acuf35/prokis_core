...
class AirInletVeSirkFan extends StatefulWidget {
  List<Map> gelenDBveri;
  bool gelenDurum;
  AirInletVeSirkFan(List<Map> dbVeriler,bool durum) {
    gelenDBveri = dbVeriler;
    gelenDurum=durum;
  }
  @override
  State<StatefulWidget> createState() {
    return AirInletVeSirkFanState(gelenDBveri,gelenDurum);
  }
}

class AirInletVeSirkFanState extends State<AirInletVeSirkFan> {
...
//--------------------------DATABASE DEĞİŞKENLER--------------------------------
  ...
  //++++++++++++++++++++++++++CONSTRUCTER METHOD+++++++++++++++++++++++++++++++
  AirInletVeSirkFanState(List<Map> dbVeri,bool drm) {
    for (int i = 0; i <= dbVeri.length - 1; i++) {
      ...
      if (dbVeri[i]["id"] == 26) {
        ...
        if (dbVeri[i]["veri1"] == "ok") {
          veriGonderildi = true;
          xx = dbVeri[i]["veri2"];
          var airinletCikis = xx.split("#");
          for (int i = 1; i <= 3; i++) {
            cikisNo[i] = int.parse(airinletCikis[i - 1]);
            cikisNoGecici[i] = int.parse(airinletCikis[i - 1]);
          }
        }
      }
    }
                          ...
                          children: <Widget>[
                            Column(
                              children: <Widget>[
                                ...
                                //Air inlet Resmi
                                Expanded(flex: 4,
                                  child: Visibility(visible: airinletAdet==0 ? false : true,
                      ...
                      Expanded(flex: 8,
                        child: Stack(fit: StackFit.expand,
                          children: <Widget>[
                            ...
                            Visibility(visible: !sirkfanVarMi,
                              child: Column(
                                children: <Widget>[
                                  Spacer(flex: 3,),
                                  Expanded(flex: 8,
                    ...
                    children: <Widget>[
                      ...
                      FlatButton(
                        onPressed: () {
                          ...
                          if(airinletAdet!=0){
                            if(cikisNo[1]==0 || cikisNo[2]==0){
                              noKontrol2=true;
                            }

                          }

                          if(sirkfanVarMi && cikisNo[3]==0){
                            noKontrol2=true;
                          }
                          ...
                          for (int i = 1; i <= 3; i++) {
                            ...
                            cikisNolar = cikisNolar + cikisNo[i].toString() + "#";
                          }
...
//++++++++++++++++++++++++++METOTLAR+++++++++++++++++++++++++++++++
  ...
  degerGiris2X0Yrd1(var val) {
    bool farkVar=false;
    if (_onlarairinlet != val[0] || _birlerairinlet != val[1]) {
  ...
  Widget _unsurCikis(int index, double oran) {
    return Expanded(
      flex: 4,
      child: Column(
        children: <Widget>[
