...
//--------------------------CONSTRUCTER METHOD--------------------------------
                                ...
                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                                  children: <Widget>[
                                    ...
                                    Container(color: Colors.blue,
                                      child: IconButton(icon: Icon(Icons.ac_unit,size: 60,), onPressed: (){
                                        _controller1.repeat();
                                      }),
                                    ),
  ...
  Widget _klepeIzlemeUnsurOnSol(double oran, String klpNo){
    ...
    return Expanded(
            flex: 8,//klpNo=="0" ? 2 : 8,
            child: Visibility(visible: klpNo=="0" ? true : true,
                          child: RotatedBox(
                quarterTurns: -2,
                child: Stack(
                  alignment:
  ...
  Widget _pedIzlemeUnsur(double oran, String pedNo){
    ...
    return Expanded(
            flex: 4,
            child: Visibility(visible: pedNo=="0" ? true : true,
                          child: Row(
                children: <Widget>[
                  Expanded(
                    flex: 2,
