...
Future MyshowModalBottomSheetQ(String dilSecimi, BuildContext context, double oran, int xqByteOnlar, int xqByteBirler, int xqBit,String baslikNo, String baslikCikis  ){
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Container(
                                                    child: RaisedButton(
                                                      ...
                                                      color: Colors.indigo,
                                                      onPressed: (){
                                                        List x=[true,qByteOnlar,qByteBirler,qBit];
                                                  ...
                                                  Container(
                                                    child: RaisedButton(
                                                      ...
                                                      splashColor: Colors.red,
                                                      onPressed: (){
                                                        List x=[false,qByteOnlar,qByteBirler,qBit];
                                                        Navigator.of(context).pop(x);
                                                      },
