...
Future MyshowModalBottomSheet4x0(String dilSecimi, BuildContext context, double oran,int xfBinler, int xfYuzler ,int xfOnlar, int xfBirler, String baslikNo, String baslikCikis  ){
