...
Future MyshowModalBottomSheet2x2(String dilSecimi, BuildContext context, double oran,int xfBinler, int xfYuzler ,int xfOnlar, int xfBirler, String baslikNo, String baslikCikis  ){

  int fBinler=xfBinler;
  int fYuzler=xfYuzler;
  int fOnlar=xfOnlar;
                                                      ...
                                                      children: <Widget>[
                                                        ...
                                                        Expanded(flex: 3,
                                                          child: RaisedButton(
                                                            ...
                                                            color: Colors.indigo,
                                                            onPressed: (){
                                                              List x=[true,fBinler,fYuzler,fOnlar,fBirler];
                                                      ...
                                                      children: <Widget>[
                                                        ...
                                                        Expanded(flex: 3,
                                                          child: RaisedButton(
                                                            ...
                                                            splashColor: Colors.red,
                                                            onPressed: (){
                                                              List x=[false,fBinler,fYuzler,fOnlar,fBirler];
                                                              Navigator.of(context).pop(x);
                                                            },
