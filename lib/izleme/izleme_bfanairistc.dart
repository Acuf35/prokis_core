...
class _IzlemeBfanAirIstcState extends State<IzlemeBfanAirIstc>
...
//--------------------------CONSTRUCTER METHOD--------------------------------
  ...
  Widget build(BuildContext context) {
    ...
    final _blocSinif =
        IzlemeBfanAirIstcBloC(context, dilSecimi, isiticiNo, dbProkis);
    blocVeri = _blocSinif;
        ...
        appBar: PreferredSize(
          ...
          child: StreamBuilder<Object>(
              ...
              builder: (context, snapshot) {
                ...
                baglantiDurum = yy[0];
                alarmDurum = yy[1];
                return Metotlar().appBar(dilSecimi, context, oran, 'tv599',
                                  ...
                                  children: <Widget>[
                                              ...
                                              child: SizedBox(
                                                child: Container(
                                                  ...
                                                  child: StreamBuilder<Object>(
                                                      initialData: "0",
                                                      stream: _blocSinif
                                                          .bloCVeriStateStreamControllerBFANCALSUR
                                                          .stream,
                                                      builder:
                                                          (context, snapshot) {
                                                        calismaSuresi =
                                              ...
                                              child: SizedBox(
                                                child: Container(
                                                  ...
                                                  child: StreamBuilder<Object>(
                                                      initialData: "0",
                                                      stream: _blocSinif
                                                          .bloCVeriStateStreamControllerBFANDURSUR
                                                          .stream,
                                                      builder:
                                                          (context, snapshot) {
                                                        durmaSuresi = int.parse(
                                                            snapshot.data);
                                                        return AutoSizeText(
                                                          durmaSuresi
                                                                  .toString() +
                                    ...
                                    Expanded(
                                      ...
                                      child: StreamBuilder<Object>(
                                          initialData: "0",
                                          stream: _blocSinif
                                              .bloCVeriStateStreamControllerBfanOTO
                                              .stream,
                                          builder: (context, snapshot) {
                                            otoBfa = snapshot.data == "1"
                                                ? true
                                                : false;
                                            return autoManGosterge(
                                                otoBfa, oran, dilSecimi);
                                          }),
                                    ),
                                    Spacer(),
                                    Expanded(
                                          ...
                                          Expanded(
                                            child: Container(
                                              ...
                                              child: StreamBuilder<Object>(
                                                  initialData: "0.0",
                                                  stream: _blocSinif
                                                      .bloCVeriStateStreamControllerBFANAKTUEL
                                                      .stream,
                                                  builder: (context, snapshot) {
                                                    String xx = snapshot.data;
                                                    String yy = bfanSurucu
                                                        ? xx
                                                        : xx.split(".")[0];
                                      ...
                                      children: <Widget>[
                                        ...
                                        Expanded(
                                          ...
                                          child: StreamBuilder<Object>(
                                              initialData: "0",
                                              stream: _blocSinif
                                                  .bloCVeriStateStreamControllerBFANDURUM
                                                  .stream,
                                              builder: (context, snapshot) {
                                                bacafanDurum =
                                                    snapshot.data == "1"
                                  ...
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                      ...
                                      child: StreamBuilder<Object>(
                                          initialData: "0",
                                          stream: _blocSinif
                                              .bloCVeriStateStreamControllerIstOTO
                                              .stream,
                                          builder: (context, snapshot) {
                                            otoIst = snapshot.data == "1"
                                                ? true
                                                : false;
                                            return autoManGosterge(
                                                otoIst, oran, dilSecimi);
                                          }),
                                    ),
                                    Spacer(
                                      flex: 8,
                    ...
                    child: Column(
                      children: <Widget>[
                                  ...
                                  child: SizedBox(
                                    child: Container(
                                      ...
                                      child: StreamBuilder<Object>(
                                          initialData: "3*1",
                                          stream: _blocSinif
                                              .bloCVeriStateStreamControllerMODveYNEM
                                              .stream,
                                          builder: (context, snapshot) {
                                            String xx = snapshot.data;
                                            var yy = xx.split("*");
                        ...
                        Expanded(
                          flex: 15,
                          child: Visibility(
                            visible: airinletAdet != "0" ? true : false,
                            child: Column(
                              children: <Widget>[
                                //Başlık
                                Expanded(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Expanded(
                                                  ...
                                                  child: StreamBuilder<Object>(
                                                      initialData: "0",
                                                      stream: _blocSinif
                                                          .bloCVeriStateStreamControllerAirOTO
                                                          .stream,
                                                      builder:
                                                          (context, snapshot) {
                                                        otoAir =
                                                  ...
                                                  child: SizedBox(
                                                    child: Container(
                                                      ...
                                                      child: StreamBuilder<
                                                          ...
                                                          initialData: "0",
                                                          stream: _blocSinif
                                                              .bloCVeriStateStreamControllerAIRDURUM
                                                              .stream,
                                                          builder: (context,
                                                              snapshot) {
                                                            airInlet1Durum =
                        ...
                        Expanded(
                          flex: 15,
                          child: Visibility(
                            visible: sirkFanAdet != "0" ? true : false,
                            child: Stack(
                              fit: StackFit.expand,
                              children: <Widget>[
                                //Başlık
                                ...
                                StreamBuilder<Object>(
                                    initialData: "0",
                                    stream: _blocSinif
                                        .bloCVeriStateStreamControllerSirkOTO
                                        .stream,
                                    builder: (context, snapshot) {
                                      otoSrk =
  ...
  Widget _bacafanHaritaUnsur(int indexNo, double oran, String baslik,
      int degerGirisKodu, BuildContext context) {
    return Expanded(
      flex: 3,
      child: Visibility(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: AnimatedBuilder(
                          animation: bacafanDurum ? _controller1 : _controller2,
  ...
  Widget _isiticiHaritaUnsur(int indexNo, double oran, String baslik,
      BuildContext context, IzlemeBfanAirIstcBloC _blocSinif) {
    return StreamBuilder<Object>(
        initialData: "0",
        stream: _blocSinif
            .bloCVeriStateStreamControllerISITICIDURUM[indexNo].stream,
        builder: (context, snapshot) {
          String xx = snapshot.data;
                          ...
                          children: <Widget>[
                            Container(
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  alignment: Alignment.center,
                                  image: AssetImage(imageGetirIsitici(
                                      isiticiHarita[indexNo])),
                                  fit: BoxFit.contain,
                                ),
                              ),
                            ),
...
class IzlemeBfanAirIstcBloC {
  ...
  List<StreamController<String>> bloCVeriStateStreamControllerISITICIDURUM =
      new List(19);
  ...
  List<StreamController<String>> bloCVeriEventStreamControllerISITICIDURUM =
      new List(19);
    ...
    if (timerSayac == 0) {
      Metotlar().takipEt("i3*", 2236).then((veri) {
        ...
        if (veri.split("*")[0] == "error") {
          ...
          for (var i = 1; i < 19; i++) {
            if (isiticiNo[i] != "0") {
              if (isiticiDurumlar[isiticiNo[i]] !=
                  isiticiDurumlarGecici[isiticiNo[i]]) {
                bloCVeriStateStreamControllerISITICIDURUM[i]
                    .sink
                    .add(isiticiDurumlar[isiticiNo[i]]);
              }
            }
          }
        ...
        if (!baglanti) {
          ...
          Metotlar().takipEt("i3*", 2236).then((veri) {
            ...
            if (veri.split("*")[0] == "error") {
              ...
              String aktuelFasVeyaHiz = xx[0];
              if (aktuelFasVeyaHiz != aktuelFasVeyaHizGecici) {
                bloCVeriStateStreamControllerBFANAKTUEL.sink
                    .add(aktuelFasVeyaHiz);
              }
              aktuelFasVeyaHizGecici = aktuelFasVeyaHiz;
              ...
              String sistemMODyukNEM = xx[7] + "*" + xx[8];
              if (sistemMODyukNEM != sistemMODyukNEMGecici) {
                bloCVeriStateStreamControllerMODveYNEM.sink
                    .add(sistemMODyukNEM);
              }
              sistemMODyukNEMGecici = sistemMODyukNEM;
