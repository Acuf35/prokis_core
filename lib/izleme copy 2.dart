                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        //Fan Harita Bölümü
                        FanStreamBuilder(dbVeriler,sutunSayisi,unsurAdet,fanHaritaGrid,fanNo,dilSecimi,fanDurum).build(context),
                        //Aktfi Mod | Air inlet - Bacafan - Isıtıcı - Sıcaklıklar
                        
                        DigerStreamBuilder1(dilSecimi, sistemModu, nemDurum, fasilaVeyaHizAktuelDeger, bfanSurucu, calismaSuresi, durmaSuresi, setSicakligi,
                         ortSicaklik, dogBolgeBitis, capBolgeBitis, airinletAdet, bacaFanAdet , isiticiAdet, sirkFanAdet, airInlet1Durum, airInlet2Durum,
                          sirkFanDurum, isiticiGr1Durum, isiticiGr2Durum, isiticiGr3Durum).build(context)
...
class FanStreamBuilder extends State<Izleme> with TickerProviderStateMixin{
  ...
  String dilSecimi="TR";
  FanStreamBuilder(List<Map> dbVeriler, int sutunSay, int unsurAd,List<int> fanHarGrid, List<String> fNo, String dilSecim, List<bool> fDurum) {
    gelenDBveri = dbVeriler;
...
class DigerStreamBuilder1 extends State<Izleme> with TickerProviderStateMixin{
  ...
  DigerStreamBuilder1(String dilSecim, int mod, int nem, String fasilaHizAktuel, bool bfanSrcu, int calisSure, int durSure,
  String setSic, String ortSic,String dogBolBit, String capBolBit, String airAdet, String bfanAdet, String istcAdet, 
  String sirFAdet, String air1Durum, String air2Durum, bool sirFdurum, bool istc1Durum, bool istc2Durum, bool istc3Durum) {
    
    dilSecimi=dilSecim;
    sistemModu=mod;
    nemDurum=nem;
    fasilaVeyaHizAktuelDeger=fasilaHizAktuel;
    bfanSurucu=bfanSrcu;
    calismaSuresi=calisSure;
    durmaSuresi=durSure;
    setSicakligi=setSic;
    ortSicaklik=ortSic;
    dogBolgeBitis=dogBolBit;
    capBolgeBitis=capBolBit;
    airinletAdet=airAdet;
    bacaFanAdet=bfanAdet;
    isiticiAdet=istcAdet;
    sirkFanAdet=sirFAdet;
    airInlet1Durum=air1Durum;
    airInlet2Durum=air2Durum;
    sirkFanDurum=sirFdurum;
    isiticiGr1Durum=istc1Durum;
    isiticiGr2Durum=istc2Durum;
    isiticiGr3Durum=istc3Durum;
...
Stream<int> _someData2(String dilSecimi) async* {
  yield* Stream.periodic(Duration(seconds: 1), (int a) {
    //_takipEt(dilSecimi);
    return a++;
  });
