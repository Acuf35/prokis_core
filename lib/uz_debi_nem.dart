  ...
  _satirlar(List<Map> satirlar) {
    ...
    for(int i=0;i<=dbSatirSayisi-1;i++){
      ...
      if(satirlar[i]["id"]==9){
        ...
        var data2=satirlar[i]["veri2"].split("*");
        k2x=data2[0];
        data2.length>1 ? k2y=data2[1] :k2y="0";
        var data3=satirlar[i]["veri3"].split("*");
        k3x=data3[0];
      ...
      if(satirlar[i]["id"]==13){
        tunelFanDebi=satirlar[i]["veri1"];
        bacaFanDebi=satirlar[i]["veri2"];
        hacimOrani=satirlar[i]["veri3"];
        disNem=satirlar[i]["veri4"]=="1" ? true : false;
      }
