...
class BacafanHaritasi extends StatelessWidget {
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                              ...
                                              child: Container(
                                                ...
                                                child: RawMaterialButton(
                                                  onPressed: () {
                                                    if (!provider
                                                        .dijitalCikis) {
                                                      provider.setdijitalCikis =
                                                          true;
                                                      provider.setanalogCikis =
                                                          false;
                                      ...
                                      Expanded(
                                        flex: 6,
                                        child: Visibility(
                                          visible: provider.bacafanKapakVarMi,
                                          child: Column(
                                            children: <Widget>[
                                              Spacer(),
                                              _bacaFanGrupCikis(
                              ...
                              Visibility(
                                ...
                                child: FlatButton(
                                  onPressed: () {
                                    ...
                                    for (int i = 1; i <= 26; i++) {
                                      veri = veri +
                                          provider.bacafanHarita[i].toString() +
                                          "#";
                                    }

                                    if (!seciliHeaterVarmi) {
                                      Toast.show(
                                          Dil().sec(dilSecimi, "toast53"),
                                          context,
                                          duration: 3);
                                    } else {
                                      for (int i = 1; i <= 26; i++) {
                                      ...
                                      Metotlar()
                                          .veriGonder("26*28*$veri*0*0*0", 2233)
                                          .then((value) {
                              ...
                              Visibility(
                                ...
                                child: FlatButton(
                                  onPressed: () {
                                    ...
                                    cikisTurSecimi =
                                        (provider.dijitalCikis ? "1" : "0") +
                                            "*" +
                                            (provider.analogCikis ? "1" : "0") +
                                            "*" +
                                            provider.cikisTur +
                                            "*" +
                                            (provider.bacafanKapakVarMi
  ...
  Widget _bacafanHaritaUnsur(
      ...
      String baslik,
      int degerGirisKodu,
      BacafanHaritasiProvider provider,
              ...
              child: RawMaterialButton(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Visibility(
                        visible: provider.haritaOnay &&
                                provider.bacafanHarita[indexNo] != 0
                            ? true
                            : false,
                        maintainState: true,
                        maintainSize: true,
  ...
  Future _resetAlert(String x, BuildContext context,
      BacafanHaritasiProvider provider, DBProkis dbProkis) async {
  ...
  Widget _bacaFanGrupCikis(int index, double oran,
      BacafanHaritasiProvider provider, bool visible, BuildContext context) {
    return Expanded(
      flex: 4,
      child: Visibility(
        visible: visible,
