                          ...
                          child: ListView(
                            ...
                            children: <Widget>[
                              ListTile(
                                ...
                                TextSpan(
                                  text: Dil().sec(dilSecimi, "info41a"),
                                  style: TextStyle(
                                    color: Colors.black,
                                    fontSize: 13*oran
                                  )
                                ...
                                TextSpan(
                                  text: Dil().sec(dilSecimi, "info41b"),
                                  style: TextStyle(
                                    color: Colors.black,
                                    fontSize: 13*oran
                                  )
                                ...
                                TextSpan(
                                  text: Dil().sec(dilSecimi, "info41c"),
                                  style: TextStyle(
                                    color: Colors.black,
                                    fontSize: 13*oran
                                  )
