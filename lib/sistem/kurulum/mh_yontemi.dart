                    ...
                    children: <Widget>[
                      ...
                      Expanded(flex: 2,
                          ...
                          onPressed: () {
                            ...
                            Metotlar().veriGonder("5*8*1*0*0*0", context, 2233, "toast", dilSecimi).then((value){
                    ...
                    children: <Widget>[
                      ...
                      Expanded(flex: 2,
                          ...
                          onPressed: () {
                            ...
                            Metotlar().veriGonder("5*8*2*0*0*0", context, 2233, "toast", dilSecimi).then((value){
                    ...
                    children: <Widget>[
                      ...
                      Expanded(flex: 2,
                          ...
                          onPressed: () {
                            ...
                            Metotlar().veriGonder("5*8*3*0*0*0", context, 2233, "toast", dilSecimi).then((value){
