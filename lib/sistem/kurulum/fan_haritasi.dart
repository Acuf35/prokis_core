        ...
        builder: (context, constraints) {
          ...
          if (sayac2 == 0) {
            new Timer.periodic(
                Duration(
                    seconds: 0,
                    milliseconds: provider.haritaOnay == true ? 100 : 1),
                (timer) {
              int unsurAdet =
                  provider.haritaOnay == true ? provider.unsurAdet : 120;
                                    ...
                                    child: RawMaterialButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        if (outNoMetin == "Q#.#") {
                                          ...
                                          qByteOnlar = int.parse(
                                              outNoMetin.length > 4
                                                  ? outNoMetin.substring(1, 2)
                                                  : "0");
                                          qByteBirler = int.parse(
                                              outNoMetin.length > 4
                                                  ? outNoMetin.substring(2, 3)
                                                  : outNoMetin.substring(1, 2));
                                          qBit = int.parse(outNoMetin.substring(
                                              outNoMetin.length - 1));
                                        }

                                        MyshowModalBottomSheetQ(
                                                dilSecimi,
                                                context,
                                                oran,
                                                qByteOnlar,
                                            ...
                                            if (haritadakiFanAdet <
                                              ...
                                              for (int i = 1; i <= 120; i++) {
                                                if (aa[i] != 0) {
                                                  ...
                                                  sayac++;
                                                  xx = true;
                                                  provider.setunsurAdet =
                                                      provider.unsurAdet + 1;
                                                  provider.setsayac =
                                                      provider.unsurAdet;
                                                }
                                                if (xx) {
                                                  ...
                                                  if (sayac2 == 0) {
                                                    provider.setsutunSayisi =
                                                        provider.sutunSayisi +
                                                            1;
                                                  }
                                                }
                                              }
                                          ...
                                          child: RawMaterialButton(
                                            ...
                                            materialTapTargetSize:
                                                MaterialTapTargetSize
                                                    .shrinkWrap,
                                            constraints: BoxConstraints(),
                                            fillColor: provider.veriGonderildi
                                                ? Colors.green[500]
                                                : Colors.blue,
                                            child: Row(
                                              mainAxisAlignment:
              ...
              onPressed: () {
                if (provider.haritaOnay) {
                  if (provider.fanHaritaGrid[indexNo] == 2) {
                    ...
                    int fBirler = sayi % 10;
                    String outNoMetin = Metotlar()
                        .outConvSAYItoQ(provider.cikisNo[indexNo + 1]);
                    int qByteOnlar;
                    int qByteBirler;
                    int qBit;
...
class FanHaritasiProvider with ChangeNotifier {
  ...
  bool dikdortgenHataVarMi() {
    ...
    for (int i = 1; i <= 10; i++) {
      for (int k = 1; k <= 10; k++) {
        if (satir[i] != satir[k] && satir[i] != 0 && satir[k] != 0) {
          dikdortgenHata = true;
        }
      }
    }
